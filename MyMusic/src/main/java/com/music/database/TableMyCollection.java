...
/**
 * Created by 501000704 on 2018/1/13.
 */

public class TableMyCollection extends BaseTable {
    private static TableMyCollection collection=new TableMyCollection();
    public static TableMyCollection creartTable(Context context){
    ...
    public static void init_data(Context context){
        ...
        MyMusicData.collectionPlayItem=new MusicPlayItem();
        MyMusicData.collectionPlayItem.musicList=list;
    }
    ...
    private static class Field{
        ...
        public static final String TABLIE_NAME="my_music_collection";
