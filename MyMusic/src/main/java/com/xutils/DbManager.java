...
public interface DbManager extends Closeable {
     ...
     * @throws DbException
     */
    <T> com.xutils.db.table.TableEntity<T> getTable(Class<T> entityType) throws DbException;
    ...
    public interface TableCreateListener {
        void onTableCreated(DbManager db, com.xutils.db.table.TableEntity<?> table);
    }
