...
public class ImageOptions {
    ...
    final void optimizeMaxSize(ImageView view) {
        ...
        int screenWidth = com.xutils.common.util.DensityUtil.getScreenWidth();
        int screenHeight = com.xutils.common.util.DensityUtil.getScreenHeight();
    ...
    public interface ParamsBuilder {
        com.xutils.http.RequestParams buildParams(com.xutils.http.RequestParams params, ImageOptions options);
    }
