...
import com.xutils.cache.LruCache;
...
/*package*/ final class ImageLoader implements
        com.xutils.common.Callback.PrepareCallback<File, Drawable>,
        com.xutils.common.Callback.CacheCallback<Drawable>,
        com.xutils.common.Callback.ProgressCallback<Drawable>,
        com.xutils.common.Callback.TypedCallback<Drawable>,
        com.xutils.common.Callback.Cancelable {

    private MemCacheKey key;
    private com.xutils.image.ImageOptions options;
    ...
    private final static LruCache<MemCacheKey, Drawable> MEM_CACHE =
            new LruCache<MemCacheKey, Drawable>(MEM_CACHE_MIN_SIZE) {
                ...
                protected int sizeOf(MemCacheKey key, Drawable value) {
                    ...
                    } else if (value instanceof com.xutils.image.GifDrawable) {
                        return ((com.xutils.image.GifDrawable) value).getByteCount();
                    }
                ...
                protected void entryRemoved(boolean evicted, MemCacheKey key, Drawable oldValue, Drawable newValue) {
                    ...
                    if (evicted && deepClear && oldValue instanceof com.xutils.image.ReusableDrawable) {
                        ((com.xutils.image.ReusableDrawable) oldValue).setMemCacheKey(null);
                    }
                }
            };
    ...
    static void clearCacheFiles() {
        com.xutils.cache.LruDiskCache.getDiskCache(DISK_CACHE_DIR_NAME).clearCacheFiles();
    }
    ...
    static Cancelable doBind(final ImageView view,
        ...
        // check params
        com.xutils.image.ImageOptions localOptions = options;
        {
            if (view == null) {
            ...
            if (localOptions == null) {
                localOptions = com.xutils.image.ImageOptions.DEFAULT;
            }
        ...
        if (oldDrawable instanceof com.xutils.image.AsyncDrawable) {
            ImageLoader loader = ((com.xutils.image.AsyncDrawable) oldDrawable).getImageLoader();
        ...
        } else if (oldDrawable instanceof com.xutils.image.ReusableDrawable) {
            MemCacheKey oldKey = ((com.xutils.image.ReusableDrawable) oldDrawable).getMemCacheKey();
    ...
    private Cancelable doLoad(ImageView view,
                              String url,
                              com.xutils.image.ImageOptions options,
        ...
        if (options.isForceLoadingDrawable()) {
            ...
            view.setImageDrawable(new com.xutils.image.AsyncDrawable(this, loadingDrawable));
        } else {
    ...
    public Drawable prepare(File rawData) {
        ...
        try {
            ...
            if (result != null) {
                if (result instanceof com.xutils.image.ReusableDrawable) {
                    ((com.xutils.image.ReusableDrawable) result).setMemCacheKey(key);
    ...
    private static RequestParams createRequestParams(String url, com.xutils.image.ImageOptions options) {
        ...
        if (options != null) {
            com.xutils.image.ImageOptions.ParamsBuilder paramsBuilder = options.getParamsBuilder();
    ...
    private boolean validView4Callback(boolean forceValidAsyncDrawable) {
        ...
        if (view != null) {
            ...
            if (otherDrawable instanceof com.xutils.image.AsyncDrawable) {
                ImageLoader otherLoader = ((com.xutils.image.AsyncDrawable) otherDrawable).getImageLoader();
                if (otherLoader != null) {
                    if (otherLoader == this) {
    ...
    private void setSuccessDrawable4Callback(final Drawable drawable) {
        ...
        if (view != null) {
            ...
            if (drawable instanceof com.xutils.image.GifDrawable) {
    ...
    private static void postArgsException(
            final ImageView view, final com.xutils.image.ImageOptions options,
