 ...
 */
public abstract class DbBase implements com.xutils.DbManager {

    private final HashMap<Class<?>, TableEntity<?>> tableMap = new HashMap<Class<?>, TableEntity<?>>();

    @Override
    @SuppressWarnings("unchecked")
    public <T> TableEntity<T> getTable(Class<T> entityType) throws com.xutils.ex.DbException {
        synchronized (tableMap) {
            ...
            if (table == null) {
                try {
                    ...
                    throw new com.xutils.ex.DbException(ex);
                }
    ...
    @Override
    public void dropTable(Class<?> entityType) throws com.xutils.ex.DbException {
    ...
    @Override
    public void dropDb() throws com.xutils.ex.DbException {
            ...
            try {
                while (cursor.moveToNext()) {
                    try {
                        ...
                        com.xutils.common.util.LogUtil.e(e.getMessage(), e);
                    }
                }
    ...
    @Override
    public void addColumn(Class<?> entityType, String column) throws com.xutils.ex.DbException {
        TableEntity<?> table = this.getTable(entityType);
    ...
    protected void createTableIfNotExist(TableEntity<?> table) throws com.xutils.ex.DbException {
