    ...
    private static void addColumns2Map(Class<?> entityType, HashMap<String, ColumnEntity> columnMap) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                com.xutils.db.annotation.Column columnAnn = field.getAnnotation(com.xutils.db.annotation.Column.class);
                if (columnAnn != null) {
                    if (com.xutils.db.converter.ColumnConverterFactory.isSupportColumnConverter(field.getType())) {
