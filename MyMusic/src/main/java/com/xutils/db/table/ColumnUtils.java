...
public final class ColumnUtils {
    ...
    public static Object convert2DbValueIfNeeded(final Object value) {
        ...
        if (value != null) {
            ...
            ColumnConverter converter = com.xutils.db.converter.ColumnConverterFactory.getColumnConverter(valueType);
    ...
    static Method findGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                com.xutils.common.util.LogUtil.d(entityType.getName() + "#" + methodName + " not exist");
            }
        }
