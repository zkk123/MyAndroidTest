...
public final class Selector<T> {
    ...
    private final com.xutils.db.table.TableEntity<T> table;

    private com.xutils.db.sqlite.WhereBuilder whereBuilder;
    private List<OrderBy> orderByList;
    private int limit = 0;
    private int offset = 0;

    private Selector(com.xutils.db.table.TableEntity<T> table) {
        this.table = table;
    }

    /*package*/
    static <T> Selector<T> from(com.xutils.db.table.TableEntity<T> table) {
        return new Selector<T>(table);
    }

    public Selector<T> where(com.xutils.db.sqlite.WhereBuilder whereBuilder) {
        this.whereBuilder = whereBuilder;
        return this;
    }

    public Selector<T> where(String columnName, String op, Object value) {
        this.whereBuilder = com.xutils.db.sqlite.WhereBuilder.b(columnName, op, value);
        return this;
    }
    ...
    public Selector<T> and(com.xutils.db.sqlite.WhereBuilder where) {
    ...
    public Selector or(com.xutils.db.sqlite.WhereBuilder where) {
    ...
    public Selector<T> expr(String expr) {
        if (this.whereBuilder == null) {
            this.whereBuilder = com.xutils.db.sqlite.WhereBuilder.b();
        }
    ...
    public com.xutils.db.table.TableEntity<T> getTable() {
        return table;
    }

    public com.xutils.db.sqlite.WhereBuilder getWhereBuilder() {
        return whereBuilder;
    }
    ...
    public T findFirst() throws com.xutils.ex.DbException {
    ...
    public List<T> findAll() throws com.xutils.ex.DbException {
        if (!table.tableIsExist()) return null;
    ...
    public long count() throws com.xutils.ex.DbException {
        if (!table.tableIsExist()) return 0;

        DbModelSelector dmSelector = this.select("count(\"" + table.getId().getName() + "\") as count");
        com.xutils.db.table.DbModel firstModel = dmSelector.findFirst();
        if (firstModel != null) {
