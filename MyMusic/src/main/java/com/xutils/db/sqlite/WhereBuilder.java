            ...
            if ("IN".equalsIgnoreCase(op)) {
                ...
                if (items != null) {
                    ...
                    for (Object item : items) {
                        ...
                        if (ColumnDbType.TEXT.equals(com.xutils.db.converter.ColumnConverterFactory.getDbColumnType(itemColValue.getClass()))) {
                ...
                if (items != null) {
                    ...
                    if (ColumnDbType.TEXT.equals(com.xutils.db.converter.ColumnConverterFactory.getDbColumnType(startColValue.getClass()))) {
                ...
                if (ColumnDbType.TEXT.equals(com.xutils.db.converter.ColumnConverterFactory.getDbColumnType(value.getClass()))) {
