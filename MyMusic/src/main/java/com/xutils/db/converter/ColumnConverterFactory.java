...
public final class ColumnConverterFactory {
    ...
    static {
        ...
        com.xutils.db.converter.CharColumnConverter charColumnConverter = new com.xutils.db.converter.CharColumnConverter();
        ...
        com.xutils.db.converter.DateColumnConverter dateColumnConverter = new com.xutils.db.converter.DateColumnConverter();
        columnType_columnConverter_map.put(Date.class.getName(), dateColumnConverter);

        com.xutils.db.converter.DoubleColumnConverter doubleColumnConverter = new com.xutils.db.converter.DoubleColumnConverter();
        columnType_columnConverter_map.put(double.class.getName(), doubleColumnConverter);
        columnType_columnConverter_map.put(Double.class.getName(), doubleColumnConverter);

        com.xutils.db.converter.FloatColumnConverter floatColumnConverter = new com.xutils.db.converter.FloatColumnConverter();
        columnType_columnConverter_map.put(float.class.getName(), floatColumnConverter);
        columnType_columnConverter_map.put(Float.class.getName(), floatColumnConverter);

        com.xutils.db.converter.IntegerColumnConverter integerColumnConverter = new com.xutils.db.converter.IntegerColumnConverter();
        ...
        com.xutils.db.converter.LongColumnConverter longColumnConverter = new com.xutils.db.converter.LongColumnConverter();
        columnType_columnConverter_map.put(long.class.getName(), longColumnConverter);
        columnType_columnConverter_map.put(Long.class.getName(), longColumnConverter);

        com.xutils.db.converter.ShortColumnConverter shortColumnConverter = new com.xutils.db.converter.ShortColumnConverter();
        columnType_columnConverter_map.put(short.class.getName(), shortColumnConverter);
        columnType_columnConverter_map.put(Short.class.getName(), shortColumnConverter);

        com.xutils.db.converter.SqlDateColumnConverter sqlDateColumnConverter = new com.xutils.db.converter.SqlDateColumnConverter();
