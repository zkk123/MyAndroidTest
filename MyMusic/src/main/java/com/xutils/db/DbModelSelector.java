...
public final class DbModelSelector {
    ...
    private com.xutils.db.sqlite.WhereBuilder having;

    private com.xutils.db.Selector<?> selector;

    private DbModelSelector(com.xutils.db.table.TableEntity<?> table) {
        selector = com.xutils.db.Selector.from(table);
    }

    protected DbModelSelector(com.xutils.db.Selector<?> selector, String groupByColumnName) {
        this.selector = selector;
        this.groupByColumnName = groupByColumnName;
    }

    protected DbModelSelector(com.xutils.db.Selector<?> selector, String[] columnExpressions) {
        this.selector = selector;
        this.columnExpressions = columnExpressions;
    }

    /*package*/
    static DbModelSelector from(com.xutils.db.table.TableEntity<?> table) {
        return new DbModelSelector(table);
    }

    public DbModelSelector where(com.xutils.db.sqlite.WhereBuilder whereBuilder) {
    ...
    public DbModelSelector and(com.xutils.db.sqlite.WhereBuilder where) {
        selector.and(where);
        return this;
    }
    ...
    public DbModelSelector or(com.xutils.db.sqlite.WhereBuilder where) {
        selector.or(where);
        return this;
    }
    ...
    public DbModelSelector having(com.xutils.db.sqlite.WhereBuilder whereBuilder) {
    ...
    public com.xutils.db.table.TableEntity<?> getTable() {
        return selector.getTable();
    }

    public DbModel findFirst() throws com.xutils.ex.DbException {
        com.xutils.db.table.TableEntity<?> table = selector.getTable();
        ...
        if (cursor != null) {
            try {
                ...
                throw new com.xutils.ex.DbException(e);
            } finally {
                com.xutils.common.util.IOUtil.closeQuietly(cursor);
            }
        }
        return null;
    }

    public List<DbModel> findAll() throws com.xutils.ex.DbException {
        com.xutils.db.table.TableEntity<?> table = selector.getTable();
        if (!table.tableIsExist()) return null;
    ...
    public String toString() {
        ...
        com.xutils.db.sqlite.WhereBuilder whereBuilder = selector.getWhereBuilder();
        ...
        List<com.xutils.db.Selector.OrderBy> orderByList = selector.getOrderByList();
