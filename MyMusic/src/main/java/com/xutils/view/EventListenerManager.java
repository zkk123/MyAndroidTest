...
import com.xutils.common.util.DoubleKeyValueMap;
...
/*package*/ final class EventListenerManager {
    ...
    public static void addEventMethod(
            ...
            ViewInfo info,
            //注解对象
            com.xutils.view.annotation.Event event,
            //页面或view holder对象
            Object handler,
            //当前注解方法
            Method method) {
                ...
                if (method != null) {
                    ...
                    if (AVOID_QUICK_EVENT_SET.contains(eventMethod)) {
                        ...
                        if (timeSpan < QUICK_EVENT_TIME_SPAN) {
                            com.xutils.common.util.LogUtil.d("onClick cancelled: " + timeSpan);
                            return null;
                        }
                    ...
                    com.xutils.common.util.LogUtil.w("method not impl: " + eventMethod + "(" + handler.getClass().getSimpleName() + ")");
                }
            }
            return null;
        }
