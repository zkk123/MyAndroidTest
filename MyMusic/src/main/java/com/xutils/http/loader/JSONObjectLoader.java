...
/*package*/ class JSONObjectLoader extends Loader<JSONObject> {
    ...
    public JSONObject load(final InputStream in) throws Throwable {
        resultStr = com.xutils.common.util.IOUtil.readStr(in, charset);
    ...
    @Override
    public JSONObject loadFromCache(final com.xutils.cache.DiskCacheEntity cacheEntity) throws Throwable {
        if (cacheEntity != null) {
