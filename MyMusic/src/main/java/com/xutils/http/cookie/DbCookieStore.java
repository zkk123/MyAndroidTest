...
public enum DbCookieStore implements CookieStore {
    ...
    private final com.xutils.DbManager db;
    ...
    DbCookieStore() {
        ...
        try {
            db.delete(CookieEntity.class, com.xutils.db.sqlite.WhereBuilder.b("expiry", "=", -1L));
        } catch (Throwable ex) {
    ...
    public List<HttpCookie> get(URI uri) {
        ...
        try {
            ...
            com.xutils.db.sqlite.WhereBuilder where = com.xutils.db.sqlite.WhereBuilder.b();

            String host = uri.getHost();
            if (!TextUtils.isEmpty(host)) {
                com.xutils.db.sqlite.WhereBuilder subWhere = com.xutils.db.sqlite.WhereBuilder.b("domain", "=", host).or("domain", "=", "." + host);
            ...
            if (!TextUtils.isEmpty(path)) {
                com.xutils.db.sqlite.WhereBuilder subWhere = com.xutils.db.sqlite.WhereBuilder.b("path", "=", path)
                ...
                for (DbModel model : uriList) {
                    ...
                    if (!TextUtils.isEmpty(uri)) {
                        try {
                            ...
                            com.xutils.common.util.LogUtil.e(ex.getMessage(), ex);
                            try {
                                db.delete(CookieEntity.class, com.xutils.db.sqlite.WhereBuilder.b("uri", "=", uri));
                            } catch (Throwable ignored) {
                                com.xutils.common.util.LogUtil.e(ignored.getMessage(), ignored);
                            }
                        }
                    }
                }
    ...
    /**
     * Remove RequestPermission cookie from store
     */
    @Override
    public boolean remove(URI uri, HttpCookie cookie) {
        ...
        try {
            com.xutils.db.sqlite.WhereBuilder where = com.xutils.db.sqlite.WhereBuilder.b("name", "=", cookie.getName());
    ...
    private void trimSize() {
        trimExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                // delete expires
                try {
                    db.delete(CookieEntity.class, com.xutils.db.sqlite.WhereBuilder
