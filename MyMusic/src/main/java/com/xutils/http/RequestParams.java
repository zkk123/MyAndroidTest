...
public class RequestParams extends BaseParams {
    ...
    private com.xutils.http.app.HttpRetryHandler httpRetryHandler; // 自定义HttpRetryHandler
    private com.xutils.http.app.RedirectHandler redirectHandler; // 自定义重定向接口, 默认系统自动重定向.
    ...
    public com.xutils.http.app.HttpRetryHandler getHttpRetryHandler() {
        return httpRetryHandler;
    }

    public void setHttpRetryHandler(com.xutils.http.app.HttpRetryHandler httpRetryHandler) {
        this.httpRetryHandler = httpRetryHandler;
    }

    public com.xutils.http.app.RedirectHandler getRedirectHandler() {
     ...
     */
    public void setRedirectHandler(com.xutils.http.app.RedirectHandler redirectHandler) {
