...
public class UrlEncodedParamsBody implements RequestBody {
    ...
    public UrlEncodedParamsBody(List<com.xutils.common.util.KeyValue> params, String charset) throws IOException {
        if (!TextUtils.isEmpty(charset)) {
            this.charset = charset;
        }
        StringBuilder contentSb = new StringBuilder();
        if (params != null) {
            for (com.xutils.common.util.KeyValue kv : params) {
                String name = kv.key;
