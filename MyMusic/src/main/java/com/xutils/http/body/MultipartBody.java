...
public class MultipartBody implements ProgressBody {
    ...
    private com.xutils.http.ProgressHandler callBackHandler;
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        if (callBackHandler != null && !callBackHandler.updateProgress(total, current, true)) {
            throw new com.xutils.common.Callback.CancelledException("upload stopped!");
        }
    ...
    private void writeEntry(OutputStream out, String name, Object value) throws IOException {
        ...
        if (value instanceof com.xutils.http.body.BodyItemWrapper) {
            com.xutils.http.body.BodyItemWrapper wrapper = (com.xutils.http.body.BodyItemWrapper) value;
