...
public class DefaultParamsBuilder implements ParamsBuilder {
     ...
     */
    @Override
    public String buildUri(com.xutils.http.RequestParams params, com.xutils.http.annotation.HttpRequest httpRequest) throws Throwable {
     ...
     */
    @Override
    public String buildCacheKey(com.xutils.http.RequestParams params, String[] cacheKeys) {
     ...
     */
    @Override
    public void buildParams(com.xutils.http.RequestParams params) throws Throwable {
    }
     ...
     */
    @Override
    public void buildSign(com.xutils.http.RequestParams params, String[] signs) throws Throwable {
