...
public final class UriRequestFactory {
    ...
    private static final HashMap<String, Class<? extends com.xutils.http.request.UriRequest>>
            SCHEME_CLS_MAP = new HashMap<String, Class<? extends com.xutils.http.request.UriRequest>>();

    private UriRequestFactory() {
    }

    public static com.xutils.http.request.UriRequest getUriRequest(RequestParams params, Type loadType) throws Throwable {
        ...
        if (!TextUtils.isEmpty(scheme)) {
            Class<? extends com.xutils.http.request.UriRequest> cls = SCHEME_CLS_MAP.get(scheme);
            if (cls != null) {
                Constructor<? extends com.xutils.http.request.UriRequest> constructor
    ...
    public static void registerRequestClass(String scheme, Class<? extends com.xutils.http.request.UriRequest> uriRequestCls) {
