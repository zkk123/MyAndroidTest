...
public class HttpRequest extends UriRequest {
    ...
    private static final CookieManager COOKIE_MANAGER =
            new CookieManager(com.xutils.http.cookie.DbCookieStore.INSTANCE, CookiePolicy.ACCEPT_ALL);

    /*package*/ HttpRequest(com.xutils.http.RequestParams params, Type loadType) throws Throwable {
    ...
    protected String buildQueryUrl(com.xutils.http.RequestParams params) {
        ...
        List<com.xutils.common.util.KeyValue> queryParams = params.getQueryStringParams();
        if (queryParams != null) {
            for (com.xutils.common.util.KeyValue kv : queryParams) {
                String name = kv.key;
    ...
    public void sendRequest() throws Throwable {
        ...
        { // write body
            com.xutils.http.HttpMethod method = params.getMethod();
            try {
            ...
            if (com.xutils.http.HttpMethod.permitsRequestBody(method)) {
                com.xutils.http.body.RequestBody body = params.getRequestBody();
                if (body != null) {
                    if (body instanceof com.xutils.http.body.ProgressBody) {
                        ((com.xutils.http.body.ProgressBody) body).setProgressHandler(progressHandler);
                    }
        ...
        if (responseCode == 204 || responseCode == 205) { // empty content
            throw new com.xutils.ex.HttpException(responseCode, this.getResponseMessage());
        } else if (responseCode >= 300) {
            com.xutils.ex.HttpException httpException = new com.xutils.ex.HttpException(responseCode, this.getResponseMessage());
            try {
                httpException.setResult(com.xutils.common.util.IOUtil.readStr(this.getInputStream(), params.getCharset()));
            } catch (Throwable ignored) {
            }
            com.xutils.common.util.LogUtil.e(httpException.toString() + ", url: " + queryUrl);
            throw httpException;
        }
    ...
    public Object loadResultFromCache() throws Throwable {
        isLoading = true;
        com.xutils.cache.DiskCacheEntity cacheEntity = com.xutils.cache.LruDiskCache.getDiskCache(params.getCacheDirName())
                .setMaxSize(params.getCacheSize())
                .get(this.getCacheKey());

        if (cacheEntity != null) {
            if (com.xutils.http.HttpMethod.permitsCache(params.getMethod())) {
    ...
    public void close() throws IOException {
        if (inputStream != null) {
            com.xutils.common.util.IOUtil.closeQuietly(inputStream);
            inputStream = null;
        }
        if (connection != null) {
