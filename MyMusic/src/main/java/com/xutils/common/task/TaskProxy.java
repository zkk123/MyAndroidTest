...
/*package*/ class TaskProxy<ResultType> extends AbsTask<ResultType> {
                    ...
                    public void run() {
                        try {
                            ...
                            if (callOnCanceled || TaskProxy.this.isCancelled()) {
                                throw new com.xutils.common.Callback.CancelledException("");
                            }
                        ...
                        } catch (com.xutils.common.Callback.CancelledException cex) {
    ...
    @Override
    public final com.xutils.common.task.Priority getPriority() {
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        com.xutils.common.util.LogUtil.d(throwable.getMessage(), throwable);
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.xutils.common.Callback.CancelledException) args[0]);
                        break;
                    }
